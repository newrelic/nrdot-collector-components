...
issue](https://github.com/newrelic/nrdot-collector-components/issues/new?assignees=&labels=Sponsor+Needed%2Cneeds+triage&projects=&template=new_component.yaml&title=New+component%3A+)
...
package fooreceiver // import "github.com/newrelic/nrdot-collector-components/receiver/fooreceiver"
```
