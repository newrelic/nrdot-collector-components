...
require (
	...
	github.com/newrelic/nrdot-collector-components/processor/adaptivetelemetryprocessor v0.0.0-20260202190745-35739fb32e8e
...
replace github.com/newrelic/nrdot-collector-components/testbed/testbed => ./testbed
