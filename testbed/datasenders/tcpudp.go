...
// https://github.com/newrelic/nrdot-collector-components/commits/main/testbed/datasenders/tcpudp.go?since=2025-11-26
//
// SPDX-License-Identifier: Apache-2.0

package datasenders // import "github.com/newrelic/nrdot-collector-components/testbed/datasenders"
...
func (f *TCPUDPWriter) Send(lr plog.LogRecord) error {
	...
	fmt.Fprintf(&sdid, "%s=%q ", "trace_id", traceutil.TraceIDToHexOrEmptyString(lr.TraceID()))
	fmt.Fprintf(&sdid, "%s=%q ", "span_id", traceutil.SpanIDToHexOrEmptyString(lr.SpanID()))
