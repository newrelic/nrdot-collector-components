...
// https://github.com/newrelic/nrdot-collector-components/commits/main/testbed/testbed/components.go?since=2025-11-26
//
...
func Components() (
	...
	/*
		Sandbox: All components must be defined in this file to be used in some tests.
	*/
