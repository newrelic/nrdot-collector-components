...
module github.com/newrelic/nrdot-plus-collector-components/cmd/nrdotpluscol
...
require (
	github.com/newrelic/nrdot-plus-collector-components/exporter/nopexporter v0.0.1
	github.com/newrelic/nrdot-plus-collector-components/receiver/nopreceiver v0.0.1
...
replace github.com/newrelic/nrdot-plus-collector-components => ../..

replace github.com/newrelic/nrdot-plus-collector-components/cmd/codecovgen => ../../cmd/codecovgen

replace github.com/newrelic/nrdot-plus-collector-components/cmd/golden => ../../cmd/golden

replace github.com/newrelic/nrdot-plus-collector-components/cmd/nrdotpluscol => ../../cmd/nrdotpluscol

replace github.com/newrelic/nrdot-plus-collector-components/cmd/nrdotplustestbedcol => ../../cmd/nrdotplustestbedcol

replace github.com/newrelic/nrdot-plus-collector-components/cmd/opampsupervisor => ../../cmd/opampsupervisor

replace github.com/newrelic/nrdot-plus-collector-components/cmd/telemetrygen => ../../cmd/telemetrygen

replace github.com/newrelic/nrdot-plus-collector-components/cmd/telemetrygen/internal/e2etest => ../../cmd/telemetrygen/internal/e2etest

replace github.com/newrelic/nrdot-plus-collector-components/exporter/nopexporter => ../../exporter/nopexporter
...
replace github.com/newrelic/nrdot-plus-collector-components/internal/tools => ../../internal/tools
...
replace github.com/newrelic/nrdot-plus-collector-components/receiver/nopreceiver => ../../receiver/nopreceiver
