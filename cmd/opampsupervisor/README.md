...
| Issues        | [![Open issues](https://img.shields.io/github/issues-search/newrelic/nrdot-plus-collector-components?query=is%3Aissue%20is%3Aopen%20label%3Acmd%2Fopampsupervisor%20&label=open&color=orange&logo=opentelemetry)](https://github.com/newrelic/nrdot-plus-collector-components/issues?q=is%3Aopen+is%3Aissue+label%3Acmd%2Fopampsupervisor) [![Closed issues](https://img.shields.io/github/issues-search/newrelic/nrdot-plus-collector-components?query=is%3Aissue%20is%3Aclosed%20label%3Acmd%2Fopampsupervisor%20&label=closed&color=blue&logo=opentelemetry)](https://github.com/newrelic/nrdot-plus-collector-components/issues?q=is%3Aclosed+is%3Aissue+label%3Acmd%2Fopampsupervisor) |
| [Code Owners](https://github.com/newrelic/nrdot-plus-collector-components/blob/main/CONTRIBUTING.md#becoming-a-code-owner)    | [@evan-bradley](https://www.github.com/evan-bradley), [@atoulme](https://www.github.com/atoulme), [@tigrannajaryan](https://www.github.com/tigrannajaryan) |

[alpha]: https://github.com/newrelic/nrdot-collector-releases/blob/main/docs/component-stability.md#alpha
...
Binary and container images for the Supervisor are available under tags starting with `cmd/opampsupervisor` [here](https://github.com/newrelic/nrdot-collector-releases/tags).
...
Binaries are available as downloadable assets from [OpenTelemetry Collector releases](https://github.com/newrelic/nrdot-collector-releases/releases) with tags using the prefix `cmd/opampsupervisor`. You can download the file containing the binary for your OS and architecture, and install it on your machine manually.
...
"https://github.com/newrelic/nrdot-collector-releases/releases/download/cmd%2Fopampsupervisor%2Fv<VERSION>/opampsupervisor_<VERSION>_<OS>_<ARCH>"
...
```sh
Invoke-WebRequest -Uri "https://github.com/newrelic/nrdot-collector-releases/releases/download/cmd%2Fopampsupervisor%2Fv<VERSION>/opampsupervisor_<VERSION>_windows_amd64.exe" -OutFile "opampsupervisor.exe"
Unblock-File -Path "opampsupervisor.exe"
```

### Container image

Container images are available for download from [GitHub Container registry](https://github.com/newrelic/nrdot-collector-releases/pkgs/container/nrdot-collector-releases%2Fnrdot-collector-opampsupervisor):

```sh
docker pull ghcr.io/newrelic/nrdot-collector-releases/nrdot-collector-opampsupervisor
```
...
By default, the supervisor will use `/var/lib/nrdotplustcol/supervisor` on posix systems, and `%ProgramData%/nrdotplustcol/Supervisor` on Windows.
...
For more details on the healthcheck configuration, see the see the [full list of `ServerConfig` options](https://github.com/newrelic/nrdot-collector-releases/tree/main/config/confighttp).
...
For a list of open issues related to the Supervisor, see [these issues](https://github.com/newrelic/nrdot-plus-collector-components/issues?q=is%3Aopen+is%3Aissue+label%3Acmd%2Fopampsupervisor).
...
| AcceptsPackages                | <https://github.com/newrelic/nrdot-plus-collector-components/issues/34734> |
| ReportsPackageStatuses         | <https://github.com/newrelic/nrdot-plus-collector-components/issues/38727> |
| ReportsOwnTraces               | ✅                                                                               |
| ReportsOwnMetrics              | ✅                                                                               |
| ReportsOwnLogs                 | ✅                                                                               |
...
| ReportsHealth                  | ⚠️                                                                               |
| ReportsStatus                  | <https://github.com/newrelic/nrdot-plus-collector-components/issues/38729> |
| ReportsRemoteConfig            | <https://github.com/newrelic/nrdot-plus-collector-components/issues/21079> |
...
| Updates the Collector binary                                       | <https://github.com/newrelic/nrdot-plus-collector-components/issues/33947> |
| Configures the Collector to report it's own metrics over OTLP      | ✅                                                                               |
| Configures the Collector to report it's own logs over OTLP         | ✅                                                                               |
| Sanitization or restriction of Collector config                    | <https://github.com/newrelic/nrdot-plus-collector-components/issues/24310> |
