...
Breaking changes can happen on any module on this folder under the [nrdot-collector contribution guidelines](https://github.com/newrelic/nrdot-collector-releases/blob/main/CONTRIBUTING.md#breaking-changes).

If you are introducing a new module that will only be used by components in the nrdot-collector-contrib repository, consider placing it on the `internal` folder instead.
